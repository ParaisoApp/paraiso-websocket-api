...
data class UserResponse(
    ...
    val routeFavorite: Map<String, Boolean>,
    val userReports: Map<String, Boolean>,
    val postReports: Map<String, Boolean>,
    val roles: UserRole,
    val banned: Boolean,
...
fun User.toUserResponse(
    ...
    UserResponse(
        ...
        routeFavorite = routeFavorite.associateWith { true },
...
fun UserResponse.toUser() =
    User(
        ...
        routeFavorite = routeFavorite.keys,
        userReports = userReports,
        postReports = postReports,
        chats = chats,
        roles = roles,
