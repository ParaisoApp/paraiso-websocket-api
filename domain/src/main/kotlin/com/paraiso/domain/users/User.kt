...
data class UserResponse(
    ...
    val routeFollowing: Map<String, Boolean>,
    val userReports: Map<String, Boolean>,
    val postReports: Map<String, Boolean>,
    val roles: UserRole,
    val banned: Boolean,
...
fun User.toUserResponse(
    ...
    UserResponse(
        ...
        routeFollowing = routeFollowing.associateWith { true },
...
fun UserResponse.toUser() =
    User(
        ...
        routeFollowing = routeFollowing.keys,
        userReports = userReports,
        postReports = postReports,
        chats = chats,
        roles = roles,
